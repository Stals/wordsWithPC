...
public:
    ...
    //Добавляет слово в usedWords
    void addUsedWord(std::string word);

    //Убирает слово из dictionary если оно там есть
...
//dictIter->first; -это буква на которую в словаре начинаются слова
//dictIter->second; - это список слов, при этом к отдельному нужно обращаться итератором
